  ...
  <div class="flex flex-col items-center justify-center px-6 mx-auto md:h-screen pt:mt-0 dark:bg-gray-900">
    ...
    <div class="w-full max-w-xl p-4 space-y-8 sm:p-8 bg-white rounded-lg border shadow-md  dark:bg-gray-800">
        ...
        <form class="mt-8 space-y-6" action="#">
            ...
            <button type="submit" class="w-full px-5 py-2 text-base font-medium text-center text-white bg-sky-400 rounded-lg hover:bg-sky-500 focus:ring-4 focus:ring-sky-500 sm:w-auto">Login</button>
            <div class="text-sm font-medium text-gray-500 dark:text-gray-400">
               Belum Punya Akun? <a class="text-sky-700 hover:underline" href="/register">Buat Akun</a>
            </div>
        </form>
    </div>
</div>
